...
Este projeto, visando a prevenção, passou por um processo de criação de um modelo de machine learning utilizando o dataset disponível em [neste link](https://github.com/RodrigoProcopio/CAD_Prediction_Database). 
